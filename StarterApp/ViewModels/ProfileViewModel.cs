...
public partial class ProfileViewModel : BaseViewModel
{
    ...
    public ProfileViewModel(IAuthenticationService authService, INavigationService navigationService, IUserNotificationService notificationService)
    {
    ...
    private async Task ChangePasswordAsync()
    {
        ...
        try
        {
            ...
            if (success)
            {
                await _notificationService.ShowAlertAsync("Success", "Password changed successfully!");
                ClearPasswordFields();
